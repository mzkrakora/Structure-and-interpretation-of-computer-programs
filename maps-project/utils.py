...
def key_of_min_value(d):
    ...
    'c'
    """
    ##note, when call min() returns the min vL, but when call key_of_min_value returns the key for the
    #the minimum value
    ##attempting to pass in key==0 as a default value
    # BEGIN Question 0
...
def mean(s):
    ...
    ##multiplying a list by a value, x, simply copies the list x number of times, it does not copy the values
    #inside the list
